...
import { Shield, BookOpen, Users, Compass, Heart, Zap, MapPin, Calendar, Clock, Globe, Award, Megaphone, Twitter, Instagram, Youtube, MessageSquare, Star } from 'lucide-react';
...
export const FEATURES = [
  ...
  },
  {
    ...
    description: 'Pendampingan spiritual intensif untuk pemuda dalam menghadapi era modern.',
...
export const EVENTS = [
  {
    id: 5,
    title: "Kajian Isra' Mi'raj",
    date: '2026-01-26',
    time: '08:00 AM',
    location: 'SMAN Colomadu',
    type: 'Spiritual',
    image: 'https://images.unsplash.com/photo-1590075865003-e48267afbc70?auto=format&fit=crop&q=100&w=1200'
  },
  {
    id: 1,
    ...
    type: 'Komunitas',
    image: 'https://images.unsplash.com/photo-1542744095-2ad48e00b216?auto=format&fit=crop&q=100&w=1200'
  },
  {
    id: 2,
  ...
  },
  {
    ...
    type: 'Spiritual',
    image: 'https://images.unsplash.com/photo-1542662565-7e4b66bae529?auto=format&fit=crop&q=100&w=1200'
  }
];
...
export const NEWS = [
  {
    id: 1,
    category: 'Inovasi',
    title: 'ROHIS SMANC Luncurkan Platform Tafsir Digital Terbaru',
...
export const TESTIMONIALS = [
  {
    ...
    avatar: 'https://i.pravatar.cc/300?u=ahmad' // Increased size to 300 for clarity
  },
  {
    id: 2,
    name: 'Sarah Nurul',
    ...
    avatar: 'https://i.pravatar.cc/300?u=sarah' // Increased size to 300 for clarity
  },
  {
    id: 3,
    name: 'Qizzy',
    role: 'Artist & Visionary',
    text: 'Mengeksplorasi geometri suci melalui seni digital memberikan dimensi baru bagi spiritualitas saya. Di sini, kreativitas adalah bentuk ibadah.',
    avatar: 'https://raw.githubusercontent.com/QizzyCO/library/refs/heads/main/ALLL%20ROLER.png'
  }
];
...
export const GALLERY = [
  {
    ...
    type: 'Kaligrafi',
    image: 'https://images.unsplash.com/photo-1502139214982-d0ad755818d8?auto=format&fit=crop&q=100&w=800'
  },
  {
    id: 2,
    title: 'Geometric Singularity',
    type: 'Pola',
    image: 'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?auto=format&fit=crop&q=100&w=800'
  },
  {
    id: 3,
    title: 'Infinite Tasbih',
    type: 'Seni Digital',
    image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=100&w=800'
  }
];

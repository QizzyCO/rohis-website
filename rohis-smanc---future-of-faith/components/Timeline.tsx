    ...
    <section id="timeline" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-slate-800 mb-6">Event <span className="text-emerald-600">Timeline</span></h2>
          <p className="max-w-2xl mx-auto text-slate-600 font-medium">
            Mark your digital calendars for our upcoming major milestones and gatherings.
          </p>
        </div>

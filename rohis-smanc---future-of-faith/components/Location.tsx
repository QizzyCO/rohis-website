    ...
    <section id="location" className="py-24 relative overflow-hidden bg-emerald-50/20">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-slate-800 mb-6">Temukan <span className="text-emerald-600">Kami</span></h2>
          <p className="max-w-2xl mx-auto text-slate-600 font-medium">
            Kunjungi pusat fisik kami di SMAN Colomadu. Pintu kami selalu terbuka untuk pertumbuhan spiritual dan dialog komunitas.
          </p>
        </div>
            ...
            <div className="glass p-8 rounded-[2.5rem] border-emerald-100 h-full flex flex-col justify-center shadow-lg shadow-emerald-900/5">
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-slate-800 font-bold uppercase text-xs tracking-widest mb-1">Alamat</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-slate-800 font-bold uppercase text-xs tracking-widest mb-1">Kontak Person</h4>

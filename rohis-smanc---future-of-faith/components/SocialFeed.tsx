      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-20">
          <div className="max-w-xl text-center md:text-left">
            <h2 className="font-serif text-4xl md:text-5xl text-slate-800 mb-6">Resonansi <span className="text-emerald-600">Digital</span></h2>
            <p className="text-slate-600 font-medium text-lg leading-relaxed">
              Terhubung dengan ekosistem terdesentralisasi kami di seluruh lanskap digital. 
              Jadilah bagian dari percakapan global tentang iman dan inovasi.
            </p>
          </div>
        ...
        <div className="relative glass rounded-[3rem] p-12 md:p-20 overflow-hidden border-emerald-100 shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left">
              <h3 className="font-serif text-3xl md:text-4xl text-slate-800 mb-4">Bergabunglah di <span className="italic text-emerald-700">Lingkaran Dalam</span></h3>
              <p className="text-slate-600 font-medium">Dapatkan akses eksklusif ke pertemuan virtual dan wawasan terbaru kami.</p>
            </div>

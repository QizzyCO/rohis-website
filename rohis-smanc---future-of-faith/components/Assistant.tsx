  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { 
        role: 'model', 
        text: "Saya menemui gangguan teknis. Mohon coba kirim pesan Anda lagi." 
      }]);
    } finally {
      setIsLoading(false);
    }
    ...
    <section id="assistant" className="py-24 relative">
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-600 font-medium">Tanyakan apa pun mulai dari panduan spiritual hingga fakta sejarah.</p>
        </div>
        ...
        <div className="glass rounded-[40px] overflow-hidden flex flex-col h-[600px] border-emerald-100 shadow-2xl">
          ...
          <div className="p-6 border-t border-emerald-50 bg-white/60">
            ...
            <p className="text-[10px] text-center text-slate-400 mt-4 uppercase tracking-widest font-bold">
              AI bisa membuat kesalahan. Selalu cari konteks Al-Quran langsung atau nasihat ulama.
            </p>
          </div>
        </div>
      </div>

      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
          <div className="max-w-xl">
            <h2 className="font-serif text-4xl md:text-5xl text-slate-800 mb-6">Kabar <span className="text-emerald-600">Terbaru</span></h2>
            <p className="text-slate-600 font-medium">
              Tetap terinformasi dengan berita terbaru, cerita komunitas, dan pembaruan dari garis depan digital ROHIS SMANC.
            </p>
          </div>
          ...
          {NEWS.map((item) => (
            <div key={item.id} className="glass p-8 rounded-[2rem] border-emerald-100 hover:border-emerald-500/30 transition-all duration-500 group flex flex-col h-full shadow-sm hover:shadow-xl hover:shadow-emerald-900/5">
              ...
              <div className="flex items-center justify-between pt-6 border-t border-emerald-50">
                <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Baca Selengkapnya</span>

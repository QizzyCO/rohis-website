      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
          <div className="max-w-xl">
            <h2 className="font-serif text-4xl md:text-5xl text-slate-800 mb-6">Pilar <span className="text-emerald-600">Keunggulan</span></h2>
            <p className="text-slate-600 leading-relaxed font-medium">
              Fondasi kita tetap tak tergoyahkan. Kami menyajikan inti ajaran iman melalui kacamata kejelasan dan aksesibilitas modern.
            </p>
          </div>

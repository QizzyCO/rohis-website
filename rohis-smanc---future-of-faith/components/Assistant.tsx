...
const Assistant: React.FC = () => {
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Assalamu Alaikum. I am Noor, your futuristic spiritual guide. How can I assist your journey today?' }
  ]);
    ...
    <section id="assistant" className="py-24 relative">
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="text-center mb-12">
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-slate-800 mb-4">Meet <span className="text-emerald-600">Noor</span></h2>
          <p className="text-slate-600 font-medium">Ask anything from spiritual guidance to historical facts.</p>
        </div>
        ...
        <div className="glass rounded-[40px] overflow-hidden flex flex-col h-[600px] border-emerald-100 shadow-2xl">
          ...
          <div className="p-6 border-t border-emerald-50 bg-white/60">
            ...
            <p className="text-[10px] text-center text-slate-400 mt-4 uppercase tracking-widest font-bold">
              AI can make mistakes. Always seek direct Quranic context or scholarly advice.
            </p>
          </div>
        </div>
      </div>
